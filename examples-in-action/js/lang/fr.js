...
LANG.pvalueWarning = (n, k, faces, probPercent) =>
  `<strong><u>Il est faux d'affirmer</u></strong> que, si l'on obtient ${k} ${faces} lors de ${n} lancers, la pièce a ${probPercent}% de chances <strong>de ne pas</strong> être biaisée vers le côté face.`;
